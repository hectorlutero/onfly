<template>
  <q-card class="max-w-[500px] w-full py-5 px-2">
    <q-card-section class="flex justify-between">
      <h2 class="font-bold text-2xl">Insert Expense</h2>
    ...
    <q-card-actions class="flex justify-end">
      <q-btn label="Insert" color="indigo" @click="insertExpense()" />
    </q-card-actions>
  </q-card>
</template>
...
export default {
  setup() {
    ...
    const expenseDate = ref(date.formatDate(today, 'YYYY-MM-DD'));
